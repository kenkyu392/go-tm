...
// The following 30 languages are defined.
// https://manuals.playstation.net/document/jp/ps4/settings/syslanguage.html

var (
	Language_csCZ = tm.Language_csCZ
	Language_daDK = tm.Language_daDK
	Language_deDE = tm.Language_deDE
	Language_enGB = tm.Language_enGB
	...
	Language_frCA = tm.Language_frCA
	Language_idID = tm.Language_idID
